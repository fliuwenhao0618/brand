...
public class Items {
    ...
    public String getIprotfolio() {
        return iprotfolio;
    }

    public void setIprotfolio(String iprotfolio) {
        this.iprotfolio = iprotfolio == null ? null : iprotfolio.trim();
    }
    ...
    public void setZishu(String zishu) {
        this.zishu = zishu == null ? null : zishu.trim();
    }
