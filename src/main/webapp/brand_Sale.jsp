...
<title>知孚IP</title>
	<link href="css/brand_Sale.css" rel="stylesheet" type="text/css" />
...
<body>
  ...
  <div id="nav">
    ...
    <ul>
      ...
      <li><a href="copyright.jsp">版权专利</a></li>
  ...
  <div id="content" >
    ...
    <div class="content">
      <div class="sale_box left">
        <p class="nav">当前位置：出售商标 > 提交信息</p>
        <form>
         <ul>
            <p>出售商标信息填写</p>
            <li><span><strong>*</strong>商标名称：</span><input type="text" /><br /></li>
            <li><span><strong>*</strong>商标注册号：</span><input type="text" /><br /></li>
            <li><span><strong>*</strong>商标类别：</span><input type="text" /><br /></li>
            <span class="question"><strong>对商标某一项目有疑问？</strong> &nbsp;<a href="#">点击查询</a></span><br />
            <li><span><strong>*</strong>联系人：</span><input type="text" /><br /></li>
            <li><span><strong>*</strong>联系电话：</span><input type="text" /><br /></li>
            <li><span>邮箱：</span><input type="text" /><br /></li>
            <li><span>地址：</span><input type="text" /><br /></li>
            <li><input class="upload" type="file" title="heiheih" value="上传附件" name="fileUpload"  /><br /></li>
            <li><input class="submit" type="submit" value="确定提交" /></li>
         </ul>
        </form>
      </div>
      
      <div class="sale_process right">
          <div class="nav">商标出售流程：</div>
          <div class="process">
            <p><span>1</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注册知孚账号</p><br />
            <p><span>2</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;提交出售信息</p><br />
            <p><span>3</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;等待信息审核</p><br />
            <p><span>4</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;成功出售商标</p>
          </div>
      </div>
    </div>
    <div class="latest_developments">
            <p>商标转让 求购信息动态</p>
            <li><span>XX分钟前</span> 用户XXX....  发布商标XXX转让消息</li>
            <li><span>XX分钟前</span> 用户XXX....  发布商标XXX转让消息</li>
     </div>
   </div>
<!--下方-->
