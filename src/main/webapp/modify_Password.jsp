...
<title>知孚IP</title>
	<link href="css/modify_Password.css" rel="stylesheet" type="text/css" />
...
<body>
  ...
  <div class="messg">
        ...
        <div id="box2">
            <ul>
            	<li><img alt="user-pic" src="images/modify_Password/img1.jpg" /></li>
                <span>账户管理</span>
                <li><a href="complete_Data.html">个人资料</a></li>
                <li><a class="active" href="modify_Password.html">更改密码</a></li>
            </ul>
        </div>
        <div id="box3">
        	<div id="box3_top"><p>更改密码</p><span>*为必填项</span></div>
        	
        	
        	<form action="${pageContext.request.contextPath }/modify_password.action" method="post">
        	
        	 <div id="box3_mid">
            	<ul>
                    <li class="li1">当前密码：<label>*</label><input class="input1" type="password" name="pw1" style="width:360px; height:36px; font-size:24px;">${errors.password }</li>
    				<p>忘记密码？找回密码</p>            	
                    <li class="li2">新的密码：<label>*</label><input class="input1" type="password" name="pw2"  style="width:360px; height:36px; font-size:24px;"></li>
                   	<li class="li3">确认密码：<label>*</label><input class="input1" type="password" name="pw3" style="width:360px; height:36px; font-size:24px;">${errors.pw }</li>
